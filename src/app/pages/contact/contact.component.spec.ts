...
describe('ContactComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [
        ContactComponent,
        MockComponents(MatError, MatLabel, MatFormField),
      ],
  ...
  it('should check name input', () => {
    ...
    component.formGroup.patchValue({
      name: 'ypkdedlnagbnprijfogiyjsctdcvbgrs',
    });
    fixture.autoDetectChanges();
    ...
    expect(matError[0].textContent?.trim()).toEqual(
      'Você excedeu o limite de 30 caracteres'
    );
    ...
    expect(matError[0].textContent?.trim()).toEqual(
      'Digite o minimo de 3 caracteres'
    );
  });
